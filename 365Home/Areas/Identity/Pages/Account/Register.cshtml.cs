...
namespace _365Home.Areas.Identity.Pages.Account
{
    //THIS WILL ALLOW ANYONE TO REGISTER
    [AllowAnonymous]
    //UNCOMMENT THIS TO CHECK FOR AUTHORIZATION
    //[Authorize]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, SD.LocationOwner);
                    ...
                    //SEND EMAIL
                    await _emailSender.SendEmailAsync(Input.Email, "365Home - Confirm your email",
